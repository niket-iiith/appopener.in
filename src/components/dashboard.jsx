...
{/*                 <select 
                    ...
                    className='text-white font-bold  bg-blue-700  md:text-white border-black border-1 py-1 px-2 rounded-1xl'>
                    <option value=".ai">.com</option>
                    <option value=".com">.ai</option>
          ...
          <div>
            <Dash_links token={props.token} newLink={props.newLink}/>
          </div>
